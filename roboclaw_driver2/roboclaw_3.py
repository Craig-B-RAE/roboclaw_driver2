# This module was obtained from Basicmicro's public GitHub repo:
# https://github.com/basicmicro/roboclaw_python_library/blob/master/roboclaw_python/roboclaw_3.py
...
#		return self._write4444444(address,self.Cmd.SETM2POSPID,long(kd*1024),long(kp*1024),long(ki*1024),kimax,deadzone,min,max)
	...
	def Open(self):
		try:
			self._port = serial.Serial(port=self.comport, baudrate=self.rate, timeout=self.timeout)
